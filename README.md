...
6. **Compras y Recepción:** Registro de órdenes de compra y recepción de insumos.
...
* **[DIAGRAMA_MER.md](DIAGRAMA_MER.md)**: Modelo Entidad-Relación interactivo en **Mermaid** con tabla de relaciones y cardinalidades.
* **`ANALISIS_EMPRESA.md`**: Análisis de negocio y procesos operativos.
